...
parser.add_argument("-N","--N_0",help="Initial population size for primary population (Default is 1e+04",default=1e+04,type=int)
...
print('coal_data written to {}.'.format(args.output_coaldir + args.output_coalname + model + suffix + '.txt'))
